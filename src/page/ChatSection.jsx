...
const ChatSection = () => {
  const [contacts, setContacts] = useState([
    { id: 1, name: "Aditya Tiwari", lastMessage: "Khaye bina mar jayenge jamin nhi bechenge 😅", unreadCount: 0 },
    { id: 2, name: "Kashish💕💕", lastMessage: "Kal College chaloge", unreadCount: 2 },
    { id: 3, name: "Sanchita 🥰", lastMessage: "kasisa h tu", unreadCount: 0 },
    { id: 4, name: "Raj Patel", lastMessage: "Bsk Madhrchod call utha", unreadCount: 14 },
    { id: 5, name: "Sachin Singh", lastMessage: "Mission accomplished bhai", unreadCount: 0 },
  ])
  return (
    <div className='w-1/4 gap-2 flex flex-col text-white'>
      ...
      <div className='h-[80%] px-8 py-4 shadow-zinc-600 rounded-xl bg-zinc-800' >
        ...
        {contacts.map(contact => (
          <div key={contact.id} className="flex items-center space-x-3 py-2 rounded-lg hover:bg-zinc-800 cursor-pointer">
